...
![Demo](https://github.com/RutvikJ77/Smart-queue-management/blob/master/media/reatil_cover.JPG)
...
[WRITEUP](https://github.com/RutvikJ77/Smart-queue-management/blob/master/Choose%20the%20Right%20Hardware%20%E2%80%93%20Proposal%20Template.pdf)

## How it Works

The [people counter script](https://github.com/RutvikJ77/Smart-queue-management/blob/master/person_detect.py) 
...
[job submission script](https://github.com/RutvikJ77/Smart-queue-management/blob/master/queue_job.sh) 
...
- [Linux/Ubuntu](https://docs.openvinotoolkit.org/latest/openvino_docs_install_guides_installing_openvino_linux.html)
- [Mac](https://docs.openvinotoolkit.org/latest/openvino_docs_install_guides_installing_openvino_macos.html)
...
![](https://github.com/RutvikJ77/Smart-queue-management/blob/master/media/How-DevCloud-works.svg)
...
The [person_detect.py](https://github.com/RutvikJ77/Smart-queue-management/blob/master/person_detect.py) file does the person
counting part for you. Try to experiment around with the threshold value and see how the predictions turn up.

### Step 2 - Job Submission

The [queue_job.sh](https://github.com/RutvikJ77/Smart-queue-management/blob/master/queue_job.sh) is the utility which  
...
* [Retail Scenario](https://github.com/RutvikJ77/Smart-queue-management/blob/master/Retail_Scenario.ipynb)
* [Manufacturing Scenario](https://github.com/RutvikJ77/Smart-queue-management/blob/master/Manufacturing_Scenario.ipynb)
* [Transportation Scenario](https://github.com/RutvikJ77/Smart-queue-management/blob/master/Transportation_Scenario.ipynb)
